...
class cnn_data_space(nn.Module):
    def __init__(self, n_filters=32, n_in_channels=3, n_out_channels = 1, kernel_size=5):
        ...
        # self.norm1 = norm_layer(n_filters)
        # self.norm2 = norm_layer(n_filters)
...
class LPD(nn.Module):
    def __init__(self, fwd_op, adjoint_op, n_filters=32, niter=10, sigma=0.01, tau=0.01): 
        super(LPD, self).__init__() #20
